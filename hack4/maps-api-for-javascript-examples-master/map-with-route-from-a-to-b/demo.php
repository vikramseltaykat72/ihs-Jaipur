...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="coor.css" />
  ...
  <body id="markers-on-the-map">
    ...
    <h2>Enter coordinates of leakage</h2>
    <a link href="two.php" target="_blank">Check routes</a>
    <a link href="one.php" target="_blank">Check routes</a>

<!--
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Enter latitude and longitude</button>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter Longitude" name="lon" required>
